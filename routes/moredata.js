//these can be viewed as import
const express = require('express');
const router = express.Router();

//here we create an array of objects containing the data we wish to fetch
const moredata = [
    {
        //here we have the data (id,title,price,previous price,
        // description,category,image,isNew simply refering
        //  to whether product is new or not, & brand)
...
//here we want to get the data, so we route the data by means of request and response
